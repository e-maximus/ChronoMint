...
export const modalsPush = ({ component, props }) =>
  (dispatch) => dispatch({ type: MODALS_PUSH, component, props })

export const modalsReplace = ({ component, props }) =>
  (dispatch) => dispatch({ type: MODALS_REPLACE, component, props })

export const modalsPop = () =>
  (dispatch) => dispatch({ type: MODALS_POP })

export const modalsClear = () =>
  (dispatch) => dispatch({ type: MODALS_CLEAR })

// Aliases. Why do we need them?
